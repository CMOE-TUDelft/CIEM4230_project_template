% White Paper style for CIEM4230 project reports
...
\let\ciemoriginalappendix\appendix
\renewcommand{\appendix}{%
    \setcounter{appendixstartpage}{\value{page}}%
    \ciemoriginalappendix
}
\AtEndDocument{%
    \clearpage
    \ifnum\value{appendixstartpage}>0
        \ifnum\numexpr\value{appendixstartpage}-1\relax>\value{maxreportpages}
            \typeout{==============================================}%
            \typeout{CIEM4230 PAGE LIMIT WARNING: main report exceeds 35 pages.}%
    ...
    \else
        \ifnum\value{page}>\value{maxreportpages}
            \typeout{==============================================}%
            \typeout{CIEM4230 PAGE LIMIT WARNING: document exceeds 35 pages.}%
            \typeout{Reduce content in the main report and move detail to appendices.}%
            \typeout{==============================================}%
...
\newcommand{\mlosection}[2]{\section{#1}\label{#2}}